Role Name
=========
ansible-hashicorp-redhat

Description
---------------
Ansible role to install the HashiCorp build automation tools like [Packer](https://www.packer.io/) and [Terraform](https://www.terraform.io/) on Red Hat Linux systems.
